...
'''
Pe noi ne intereseaza loop-ul de la final, cu while True
Sunt doua chestii interesante acolo: in_nn si in_nn_input

Sunt sigur ca unul din astea doua tine informatia pe care o foloseste
codul ( sunt destul de sigur ca acel obiect este nn_input, dar nu sunt
100% sigur)

Cand voi merge marti la scoala va trebui sa vad ce se intampla daca le aplic la 
unul dintre aceste doua obiecte print()
